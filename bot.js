...
bot.on("message", async (ctx) => {
  if (ctx.message.location) {
    ...
    const url =
      `https://api.openweathermap.org/data/2.5/weather?lat=${ctx.message.location.latitude}&lon=${ctx.message.location.longitude}&appid=2cfcde3b698fd53929ac959947ebc9ae&units=metric`;
